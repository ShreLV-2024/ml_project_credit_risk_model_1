...
def prepare_df(age, income, loan_amount, loan_tenure_months,
                                            avg_dpd_per_delinquency, deliquent_to_loan_months,
    ...
    input_data = {
        ...
        'deliquent_to_loan_months': deliquent_to_loan_months,
        ...
        # add additional fields (since cols_to_scale has more cols than the final cols
...
def calculate_credit_score(input_df, base_score = 300, scale_length = 600): # scale_length is 600 because we add it to base to give us 900(max credit score)
    x = np.dot(input_df.values, model.coef_.T) + model.intercept_   #y = mx+b and here we will apply sigmoid function
